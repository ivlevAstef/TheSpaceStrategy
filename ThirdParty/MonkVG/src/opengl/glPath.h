...
//			}
  ...
  private:
    ...
    vector<textured_vertex_t> _texturedVertices;
  ...
  private:		// tesseleator callbacks
    static void CALLBACK tessBeginData(GLenum type, GLvoid* user);
    static void CALLBACK tessEndData(GLvoid* user);
    static void CALLBACK tessVertexData(GLvoid *vertex, GLvoid* user);
    static void CALLBACK tessCombineData(GLdouble coords[3], void *data[4],
                GLfloat weight[4], void **outData,
                void *polygonData );
    static void CALLBACK tessErrorData(GLenum errorCode, GLvoid* user);
