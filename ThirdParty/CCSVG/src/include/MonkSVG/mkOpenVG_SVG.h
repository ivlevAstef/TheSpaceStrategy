...
#include "MonkSVG/mkTransform2d.h"
...
namespace MonkSVG {
  ...
  private:	
    ...
    friend std::shared_ptr<OpenVG_SVGHandler> std::make_shared<>();
  ...
  private:
    ...
    struct group_t {
      ...
      Transform2d			transform;
      group_t*			parent;
      std::list<group_t>		children;
      std::list<path_object_t> path_objects;
    ...
    std::vector<Transform2d>		_transform_stack;
